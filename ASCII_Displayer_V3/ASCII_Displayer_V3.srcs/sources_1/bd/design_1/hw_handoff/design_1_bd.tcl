...
# module references:
# AsciiCharsMem, Debounce_Switch, Debounce_Switch, ScreenBufferMem, VGA_pattern, VGA_timings, num_capture_4bit
...
proc create_root_design { parentCell } {
  ...
  set iColor [ create_bd_port -dir I iColor ]
  set iPull [ create_bd_port -dir I iPull ]
  set iPush [ create_bd_port -dir I iPush ]
  ...
  # Create instance: num_capture_4bit_0, and set properties
  set block_name num_capture_4bit
  set block_cell_name num_capture_4bit_0
  if { [catch {set num_capture_4bit_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $num_capture_4bit_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net AsciiCharsMem_0_oData [get_bd_pins AsciiCharsMem_0/oData] [get_bd_pins VGA_pattern_0/iDataA2]
  connect_bd_net -net Debounce_Switch_0_o_Switch [get_bd_pins Debounce_Switch_0/o_Switch] [get_bd_pins num_capture_4bit_0/iPush]
  connect_bd_net -net Debounce_Switch_1_o_Switch [get_bd_pins Debounce_Switch_1/o_Switch] [get_bd_pins num_capture_4bit_0/iStop]
  ...
  connect_bd_net -net VGA_pattern_0_oAddrA2 [get_bd_pins AsciiCharsMem_0/iAddr] [get_bd_pins VGA_pattern_0/oAddrA2]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AsciiCharsMem_0/iClk] [get_bd_pins ScreenBufferMem_0/iClk] [get_bd_pins VGA_pattern_0/iClk] [get_bd_pins VGA_timings_0/iClk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins num_capture_4bit_0/iClk]
  connect_bd_net -net iClk_1 [get_bd_ports iClk] [get_bd_pins Debounce_Switch_0/i_Clk] [get_bd_pins Debounce_Switch_1/i_Clk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net iColor_0_1 [get_bd_ports iColor] [get_bd_pins VGA_pattern_0/iColor]
  connect_bd_net -net iPull_0_1 [get_bd_ports iPull] [get_bd_pins num_capture_4bit_0/iPull]
  connect_bd_net -net iRst_1 [get_bd_ports iRst] [get_bd_pins ScreenBufferMem_0/iRst] [get_bd_pins VGA_pattern_0/iRst] [get_bd_pins VGA_timings_0/iRst] [get_bd_pins num_capture_4bit_0/iRst]
  connect_bd_net -net i_Switch_0_1 [get_bd_ports iPush] [get_bd_pins Debounce_Switch_0/i_Switch]
